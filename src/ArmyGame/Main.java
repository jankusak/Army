...
public class Main {
    public static void main(String[] args) {
        ...
        final DwarfDefender dwarfDefender1 = new DwarfDefender("Gimli");
        ...
        army.addSoldier(dwarfDefender1);
        ...
        army.displaySpell();
        army.displayHealing();
        army.displaySpecialHealing();
        army.displaySpecialMagic();
        army.displaySpecialAttack();
    }
}